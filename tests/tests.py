...
from django_tasks_db import ResultStatus, Task, default_task_backend, tasks
from django_tasks_db import DatabaseBackend
from django_tasks_db.management.commands.db_worker import (
    logger as db_worker_logger,
)
from django_tasks_db.models import DBTaskResult
from django_tasks_db.utils import exclusive_transaction, normalize_uuid
...
class DatabaseBackendWorkerTestCase(TransactionTestCase):
    ...
    def test_complex_exception(self) -> None:
        ...
        ), self.assertLogs("django_tasks_db", level="ERROR"):
            self.run_worker()
